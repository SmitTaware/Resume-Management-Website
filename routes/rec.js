...
router.post("/rec", async (req, res) => {
    ...
    try {
       const Record = await dbOperation.createRec(req.session.user._id,req.session.user.userName,req.body.company,req.body.position,req.body.jobD,CV,req.body.appS);
